...
const { writeFileSync, createReadStream, unlinkSync, createWriteStream } = require("fs");
...
module.exports.getStreamFromURL = async function (url, path) {
  try {
    ...
    console.log(`getStreamFromURL failed for ${url}:`, error.message);
